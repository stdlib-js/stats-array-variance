...
var o=require('@stdlib/assert-is-collection/dist'),v=require('@stdlib/assert-is-number/dist').isPrimitive,m=require('@stdlib/array-dtypes/dist'),l=require('@stdlib/array-dtype/dist'),g=require('@stdlib/array-base-assert-contains/dist'),c=require('@stdlib/array-base-join/dist'),d=require('@stdlib/stats-strided-variance/dist').ndarray,i=require('@stdlib/error-tools-fmtprodmsg/dist'),t=m("real_and_generic"),p="generic";function q(e){var r,a;if(!o(e))throw new TypeError(i('2PP2O',e));if(a=l(e)||p,!g(t,a))throw new TypeError(i('2PPHZ',c(t,'", "'),a));if(arguments.length>1){if(r=arguments[1],!v(r))throw new TypeError(i('2PP4A',r))}else r=1;return d(e.length,r,e,1,0)}n.exports=q
